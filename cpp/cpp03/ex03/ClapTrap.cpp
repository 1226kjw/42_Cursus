...
{
	cout << name << "(ClapTrap) constructor called" << endl << endl;
}
...
ClapTrap::~ClapTrap()
{
	cout << name << "(ClapTrap) destructor called" << endl << endl;
}

ClapTrap& ClapTrap::operator=(const ClapTrap& c)
{
	cout << this->name << "(ClapTrap) assignation operator called" << endl << endl;
	name = c.name;
	hp = c.hp;
	ep = c.ep;
	ad = c.ad;
